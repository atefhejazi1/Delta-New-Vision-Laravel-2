...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('home')}}">
            ...
            <div class="sidebar-brand-text mx-3"> Delta New vision</div>
        </a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Content Row -->
                <form action="{{ url('storeCompanyProduct') }}" method="POST" enctype="multipart/form-data">

                    @csrf
                    <div class="mb-3">
                        <label for="companyProductName" class="form-label">Company Product Name</label>
                        <input type="text" name="companyProductName" class="form-control" id="companyProductName">
                    </div>
                    <div class="mb-3">
                        <label for="companyProductDescription" class="form-label">Company Product Description</label>
                        <div>
                            <textarea style="width: 100%" name="companyProductDescription"
                                      id="companyProductDescription"
                                      rows="7"></textarea>
                        </div>
                    </div>
                    {{--                    <div class="mb-3">--}}
                    ...
                    <div class="mb-3">
                        <label for="company_id" class="form-label">Product Name</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input style="padding: 2px 0" class="form-control" type="file" id="formFile"
                               name="companyProductImage">
                    </div>

                    <button type="submit" class="btn btn-primary">Add Company Product</button>
                </form>
