        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <form action="{{ url('/product/update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="productName" class="form-label">Product Company Name</label>
                        <input type="text" name="productName" value="{{$companyProduct->companyProductName}}"
                               class="form-control"
                               id="productName">
                    </div>
                    <div class="mb-3">
                        <label for="productDescription" class="form-label">Product Company Description</label>
                        <div>
                            <textarea style="width: 100%" name="productDescription" id="productDescription"
                                      rows="7">
                                {{$companyProduct->companyProductDescription}}
                            </textarea>
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" name="companyName" class="form-control"
                               value="{{$companyProduct->companyName}}"
                               id="companyName">
                    </div>
                    <div class="mb-3">
                        <label for="formFile" class="form-label">Product Company Image</label>
                        <input style="padding: 2px 0" class="form-control" type="file" id="formFile"
                               name="companyProductImage">
                    </div>

                    <button type="submit" class="btn btn-primary">Update Company Product</button>
                </form>
