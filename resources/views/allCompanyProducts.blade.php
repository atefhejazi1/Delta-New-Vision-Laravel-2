            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <table class="table table-dark table-striped">
                        ...
                        <tr>
                            <th scope="col">#</th>
                            <th scope="col">Product Company Name</th>
                            <th scope="col">Product Company Description</th>
                            <th scope="col">Company Name</th>
                            <th scope="col">Product Company Image</th>
                        ...
                        @foreach ($companyProducts as $product)
                            <tr>
                                <th scope="row">{{++$x }}</th>
                                <td>{{$product->companyProductName}}</td>
                                <td>{{$product->companyProductDescription}}</td>
                                <td>{{$product->company->companyName}}</td>
                                <td>
                                <img style="width: 200px ;"
                                     src="{{asset('images/company-products/'. $product->companyProductImage)}}" alt=""></td>

                                <td>
                                    <a class="btn btn-success btn-sm" href={{"/companyProduct/edit/". $product->id}}>Update</a>
                                    <a class="btn btn-danger btn-sm" href={{"/deleteCompanyProduct/". $product->id}}>Delete</a>
                                </td>
                            </tr>
                        @endforeach
